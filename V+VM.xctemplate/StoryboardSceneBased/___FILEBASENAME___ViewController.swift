...
final class ___FILEBASENAMEASIDENTIFIER___: BaseViewController, ViewModelBased,  StoryboardSceneBased {

	//StoryboardSceneBased implementation
	public static var sceneStoryboard: UIStoryboard = UIStoryboard(name: <#type name#>, bundle: .main)
